...
- [Start the server and open StrainVis web-application](#start-the-server-and-open-strainvis-web-application)
...
In order to set a different value of subsampled-regions using the slider, you should first clear the currently presented plots 
by clicking the 'Clear plots and select new number of regions' button.
